...
> R:inicializa carrito(cantidad 0)
...
> R:el test falló, se obtuvo 350 y se esperaba 700
...
> R:falla, devuelve  "[FAIL] carrito_agregar(&c, pan) => esperado 0, obtenido 1  (linea 62)"
...
> R:la diferencia es que el test de integración testea la sinergia entre funciones
...
> R:la ventaja es que ahorra tiempo detectando el error
